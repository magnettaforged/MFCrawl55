...
// Def labels updated to PDEF; effect keys kept compatible with runeLoader.
// =========================
...
const RUNE_DATA = {
  ...
  "thurisaz": {
    ...
    "baseValue": 10,
    "color": "crimson",
    "shortLabel": "-10% Enemy PDEF",
    "description": "Ignores 10% of enemy physical defense."
  },
  "ansuz": {
    "runeName": "Ansuz",
    "image": "rune4.png",
  ...
  "algiz": {
    ...
    "color": "silver",
    "shortLabel": "+10% PDEF",
    "description": "Physical defense increased by 10%."
  },
  "sowilo": {
    "runeName": "Sowilo",
    "image": "rune12.png",
